...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/10/25 18:25:49 by vjose             #+#    #+#             */
/*   Updated: 2021/10/25 18:25:49 by vjose            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static char	*ft_end_of_file(char *remainder, char *line, char *buf, int r)
{
	free(buf);
	if (r < 0)
		return (NULL);
...
char	*get_next_line(int fd)
{
	...
	while (1)
	{
		...
		if (r >= 0)
			buf[r] = '\0';
		if (r <= 0)
			return (ft_end_of_file(remainder, line, buf, r));
